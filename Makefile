...
# Project:  cs4098.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile cs4098.pro
#############################################################################
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I. -Isrc -I/usr/include/qt5 -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
Makefile: cs4098.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/cs40981.0.0 || mkdir -p .tmp/cs40981.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cs40981.0.0/ && $(COPY_FILE) --parents ui_mainwindow.h src/mainwindow.h src/ui_mainwindow.h .tmp/cs40981.0.0/ && $(COPY_FILE) --parents src/main.cpp src/mainwindow.cpp .tmp/cs40981.0.0/ && (cd `dirname .tmp/cs40981.0.0` && $(TAR) cs40981.0.0.tar cs40981.0.0 && $(COMPRESS) cs40981.0.0.tar) && $(MOVE) `dirname .tmp/cs40981.0.0`/cs40981.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cs40981.0.0
